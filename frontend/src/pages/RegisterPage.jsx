    ...
    <div className="min-h-screen bg-abstract-lavender flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white p-8 rounded-xl shadow-lg border border-gray-100">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600">Join AgriMit today</p>
        </div>
        ...
        <p className="mt-6 text-center text-gray-600 text-sm">
          Already have an account? <Link to="/login" className="text-abstract-blue font-semibold hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  );
